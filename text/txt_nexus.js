...
const tipbotTxt = {
  ...
  'helpText': [
    ...
    '\t\t_@NexusBot what is my balance_',

    //'help_send':
    '*send*\t\t\t\ttell the bot to send coins to someone; \n' +
    '\t\t_@NexusBot send 0.1 NXS to @someone_ \n' +
    '\t\t_aliases: give, tip_ \n' +
    '\t\t\t\tWorks also with major fiat currencies (use *currencies* command to see the list); \n' +
    '\t\t_@NexusBot give 4 USD to @someone_',

    // 'help_deposit':
    '*deposit*\t\task the bot for a deposit address; _@NexusBot let me deposit!_',
    ...
    '\t\t_@NexusBot 0.03 NXS to GBP_ \t or \t _@NexusBot 15 EURO to NXS_\n',
  ...
  // NEW USER
  'WarningNewUser1': 'A new user joins Nexus Nation! A warm welcome to our Slack, ',
  'WarningNewUser2': '.',
  // USER LEFT
  ...
  // 'RainPerUser2': ' NXS would fall',
  // 'RainClouds': ':rain_cloud: :rain_cloud: :rain_cloud:',
  // 'RainNow': '*And the Nexus Rain Gods said _LET IT RAIN NXS_* \n' +
  ...
  // 'RainRecieved': ':droplet: \n You got splashed with a Nexus raindrop of ',
  ...
  'SunThresholdNotSet': 'Dear Nexus God, the Sun threshold isn\'t set yet. \n' +
  ' You can do that with the *sun threshold _amount_* command.',
  // 'SunTimer': 'Sunshine will be checked every *',
  // 'SunTimerUnit': ' minute(s)*',
  // 'SunTimerNotSet': 'Dear Nexus God, the sun timer is not set yet.\n' +
  ...
  'SunReqDonation3': '_ will be redistributed as _sunrays_ (aka free Nexus).',
  'SunEmpty': ':sun_behind_cloud:no sunrays available to cast. :disappointed:',
  'SunRecieved': 'As reward of tipping your fellow Nexus user(s) you received a sunray of ',
