...
var TipBot = function (RPC_USER, RPC_PASSWORD, RPC_PORT, OPTIONS, WALLET_PASS) {
    ...
    self.OPTIONS = _.defaults(OPTIONS, {
        ...
        PRICETICKER_BOUNDARY: 0.1 // check boundaries ever x minutes
    ...
    self.priceTicker.TitleBrokenBuyBoundary = "--- Price droped below the boundary. The new boundary is ";
    self.priceTicker.TitleBrokenSellBoundary = "+++ Price raised above the boundary. The new boundary is ";
    self.priceTicker.priceDigits = 4;
    self.priceTicker.diffDigits = 4;
    self.priceTicker.boundaryDigits = 2;
...
TipBot.prototype.updatePriceTicker = function () {
    ...
    self.getPriceRates(function (err, rates) {
        ...
        if (!rate) {
            ...
            self.priceTicker.setNewPrices(rate, rate,
                function () {
                    ...
                    if (self.OPTIONS.PRICETICKER_CHANNEL !== undefined) {
                        self.slack.say({
                            channel: self.OPTIONS.PRICETICKER_CHANNEL.idŸ,
