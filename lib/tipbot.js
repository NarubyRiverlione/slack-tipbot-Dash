    ...
    if (message.match(/(convert|rate|to)/i)) {
        ...
        if (currencies.length < 2) {
            ...
            if (amount === null) {
                ...
                //currency = _.without(currencies.map(function(s) { return s.toLowerCase(); }), amount[2].toLowerCase());
                        ...
                        if (rate === false) {
                            ...
                            self.getPriceRates(function(err, rates) {
                                ...
                                if (!rate) {
                                    ...
                                    channel.send(newValue.toFixed(2) + " " + currency + " (" + rate.toFixed(2) + " " + currency + " / DASH)");
                                }
                            });
                        }
                    });
