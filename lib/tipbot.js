    ...
    self.getDirectMessageChannelID(channel, user.id, function (err, DMchannelID) {
        ...
        */
        ...
        if (message.match(/\bwithdraw\b/i)) {
            ...
            if (amount === null) {
               // amount = message.match(/\ball\b/i); // check for 'all' word
              //  if (amount === null) {
        ...
        if (message.match(/\bprice\b/i)) {
            ...
            if (currency) {
                ...
                self.showPriceTicker(channel.id, false);
                return;
            }
                ...
                if (userMatches.length == 0) {
                    ...
                    self.getDirectMessageChannelID(null, warnUser.id, function (err, DMchannelID) {
                        ...
                        /*
                           ...
                           var warningText = personalMessage.length > 1 ? personalMessage : self.text["WarnText"];
                           debug("Warning text = '" + warningText + "'");
     */
                        // send DM 
                        var warnMessage = {
                            channel: DMchannelID,
