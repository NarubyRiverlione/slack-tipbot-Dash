...
function createMessage(coin) {
    ...
    if (coin.buyPrice !== 0 && coin.sellPrice !== 0) {
        ...
        message += showPrice(coin.buyTitle, coin.localCoin, coin.buyPrice, coin.priceDigits, coin.boundaryDigits);
        ...
        message += coin.sellPrice + " " + coin.localCoin;
...
function showPrice(priceTitle, localCoin, price, digits) {
    return priceTitle + " " + localCoin + " " + price.toFixed(digits);
}
